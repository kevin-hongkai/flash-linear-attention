...
from fla.ops.utils import prepare_chunk_indices, prepare_chunk_offsets, prepare_lens
    ...
    for i_k in range(NK):
        ...
        for i_h in range(H):
            ...
            if USE_G:
                ...
                # p_g = tl.make_block_ptr(g_h, (T,), (H,), (i_t * BT,), (BT,), (0,))
                p_g = tl.make_block_ptr(g_h, (T,), (1,), (i_t * BT,), (BT,), (0,))
                b_g = tl.load(p_g, boundary_check=(0,))
                # b_g_last = tl.load(g_h + (min(i_t * BT + BT, T) - 1) * H)
                ...
                # p_dg = tl.make_block_ptr(dg_h, (T,), (H,), (i_t * BT,), (BT,), (0,))
